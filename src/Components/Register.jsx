  ...
  const from = location ?.state || "/";
    ...
    return (
        ...
        <Navber></Navber>
           ...
           <div className='flex  items-center p-5 shadow-2xl shadow-blue-200 max-w-[1200px] mx-auto bg-white'>

             {/* side image section  */}
            
          <div>
            <img className='w-6xl h-96' src="https://i.postimg.cc/PqVM5BbB/cloud-computing-modern-flat-concept-for-web-banner-design-man-enters-password-and-login-to-access-cl.jpg" alt="" />
          </div>
